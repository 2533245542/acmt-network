...
context_measurements <- get_acmt_standard_array(long=-122.333, lat=47.663, radius_meters = 2000, year=2013, external_data_name_to_info_list=external_data_name_to_info_list)
```

```{r}
print(head(context_measurements[context_measurements$variable == "mRFEI", ]))
```
...
expect_true(is.na(context_measurements[204, 2]))
```
