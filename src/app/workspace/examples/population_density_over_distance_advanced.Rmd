...
tryCatch({  # note that codes in try is not inside a new function, just treat it as normal R code
  ##try and geocode all of the addresses:
...
## tests
library(testthat)
expect_equal(filter(dataframe_for_plotting[dataframe_for_plotting$variable == "population_density", ], city_hall=="seattle_city_hall", radius==2000)$value,0.006712986)
